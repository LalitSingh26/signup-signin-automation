...
public class SignUpAndSignIn {
    ...
    public void FillAllRequiredFields() {
        ...
        createAccountPage.fillInRequiredFields("Lalit", "Singh", generatedEmail, "Password123!");
    }
    ...
    public void FillEmailFieldWithAnExistingEmailAddress() {
        ...
        createAccountPage.enterFirstName("Lalit");
        createAccountPage.enterLastName("Singh");
